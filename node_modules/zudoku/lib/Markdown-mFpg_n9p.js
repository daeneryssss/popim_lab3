...
import { d as io, g as Nr, u as Or, b as ao, h as so } from "./chunk-BAXFHI7N-BVBOl9s0.js";
import { c as vi } from "./index-CPNSgwSb.js";
import { ChevronRightIcon as oo, ExternalLinkIcon as lo } from "lucide-react";
import { N as co, j as fo, f as ho } from "./hook-CldJlP5c.js";
...
function qa(e, t) {
  ...
  return (e.index === 0 || rt(n) || Hn(n)) && // If it’s an email, the previous character should not be a slash.
  (!t || n !== 47);
}
function un(e) {
...
//# sourceMappingURL=Markdown-mFpg_n9p.js.map
