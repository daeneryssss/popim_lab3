...
import { BuildCheck, Layout, RouteGuard, RouterError, StatusPage, Zudoku, } from "zudoku/components";
...
export const getRoutesByOptions = (options, enableStatusPages = false) => {
    const allPlugins = [
        ...(options.plugins ?? []),
    ...
    const routes = allPlugins
        ...
        ? [400, 403, 404, 405, 414, 416, 500, 501, 502, 503, 504].map((statusCode) => ({
...
export const getRoutesByConfig = (config) => {
    ...
    return [
        {
            element: (_jsxs(Zudoku, { ...options, children: [_jsx(BuildCheck, { buildId: import.meta.env.IS_ZUPLO && import.meta.env.ZUPLO_BUILD_ID
                            ? import.meta.env.ZUPLO_BUILD_ID
                            : undefined }), _jsx(Layout, {})] })),
            children: [
                {
                    element: _jsx(RouteGuard, {}),
