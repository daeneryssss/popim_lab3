...
const KbdShortcut = () => {
    const os = detectOS();
    return (_jsxs("kbd", { className: "absolute right-1.5 hidden h-5 select-none items-center gap-1 rounded-sm border bg-muted px-1.5 font-mono text-[11px] font-medium opacity-100 sm:flex", children: [os === "macOS" ? "⌘" : "Ctrl", "+K"] }));
};
