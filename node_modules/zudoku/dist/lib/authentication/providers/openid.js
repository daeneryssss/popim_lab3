    ...
    getRoutes() {
        return [
            ...super.getRoutes(),
            {
                ...
                element: (_jsx(ClientOnly, { children: _jsx(CallbackHandler, { handleCallback: this.handleCallback }) })),
            },
        ];
    }
}
export class OpenIDAuthenticationProvider {
    ...
    constructor({ issuer, audience, clientId, redirectToAfterSignUp, redirectToAfterSignIn, redirectToAfterSignOut, basePath, scopes, }) {
        ...
        this.absoluteCallbackUrlPath = joinUrl(basePath, this.relativeCallbackUrlPath);
    ...
    async getAccessToken() {
        ...
        if (new Date(tokenState.expiresOn) < new Date()) {
            ...
            const request = await oauth.refreshTokenGrantRequest(as, this.client, tokenState.refreshToken);
    ...
    getAuthenticationPlugin() {
        ...
        return new OpenIdAuthPlugin(this.relativeCallbackUrlPath, this.handleCallback);
    }
}
