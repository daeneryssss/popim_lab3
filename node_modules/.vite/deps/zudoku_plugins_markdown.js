...
// node_modules/zudoku/lib/zudoku.plugin-markdown.js
var h = Object.defineProperty;
var g = (e, t, o) => t in e ? h(e, t, { enumerable: true, configurable: true, writable: true, value: o }) : e[t] = o;
    ...
    return e.forEach(
      ({ fileImports: o, files: n, defaultOptions: a }) => Object.entries(o).flatMap(([s, i]) => {
        ...
        const u = {
          path: r,
          lazy: async () => {
            const { MdxPage: p } = await import("./MdxPage-Cm7atiW3-2YGDUZ7G.js"), { default: f, ...l } = await i();
            return {
              element: ae.jsx(
                p,
                {
...
//# sourceMappingURL=zudoku_plugins_markdown.js.map
