...
export declare const ClerkComponents: {
    ...
    PlanDetails: import("react").LazyExoticComponent<(props: import("@clerk/types").__experimental_PlanDetailsProps) => import("@emotion/react/jsx-runtime").JSX.Element>;
};
