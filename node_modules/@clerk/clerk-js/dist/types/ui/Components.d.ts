import type { __experimental_CheckoutProps, __experimental_PlanDetailsProps, __internal_UserVerificationProps, Appearance, Clerk, ClerkOptions, EnvironmentResource, SignInProps, SignUpProps, UserProfileProps, WaitlistProps } from '@clerk/types';
...
export type ComponentControls = {
    ...
    openDrawer: <T extends 'checkout' | 'planDetails'>(drawer: T, props: T extends 'checkout' ? __experimental_CheckoutProps : T extends 'planDetails' ? __experimental_PlanDetailsProps : never) => void;
